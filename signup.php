                ...
                <form id="signupForm" method="POST" action="/subsystem1/signup">
                    ...
                    <div class="form-floating mb-3">
                        <select class="form-select" id="gender" name="gender" required>
                            <option value="" disabled <?php echo !isset($gender) ? 'selected' : ''; ?>></option>
                    ...
                    <div class="form-floating mb-3 position-relative">
                        ...
                        <button type="button" class="btn btn-outline-light position-absolute end-0 top-50 translate-middle-y me-2" id="togglePassword">
